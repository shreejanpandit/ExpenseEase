...
<body>
                    ...
                    <form action="{{route('transaction.store')}}" method="post" >
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{old('amount')}}" class=" @error('amount') is-invalid @enderror form-control form-control-lg" placeholder="Amount"
                                    name="amount">
                                    @error('amount')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" value="{{old('description')}}" cols="30" rows="5" class=" @error('description') is-invalid @enderror form-control"
    ...
    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.7/dist/umd/popper.min.js"
        integrity="sha384-qasE+TvO9oK8SqVjTzG4jqYTLRkTTsUwZ4EKQmOuZwbIe7Bh7Ib8F2fgsxODGbCs" crossorigin="anonymous">
    </script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.min.js"
        integrity="sha384-rbcdm3Cjf6Qvf3WB5V9F+zCtfOBRCUXqjJ9twH7OH+Jwtx+rca4eYEGiI5H1k1CI" crossorigin="anonymous">
    </script>
